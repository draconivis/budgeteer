 ...
 */
final class Version20240511083025 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE budget');
        $this->addSql('CREATE TABLE budget (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER NOT NULL, starting_value NUMERIC(8, 2) NOT NULL, current_value NUMERIC(8, 2) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, deleted BOOLEAN NOT NULL, CONSTRAINT FK_73F2F77B7E3C61F9 FOREIGN KEY (owner_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
